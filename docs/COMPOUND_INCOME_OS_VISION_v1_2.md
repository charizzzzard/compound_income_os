# Compound Income OS — Vision v1.2
...
Hinweis: Die im Lese-Vertrag genannten Repo-Zahlen beschreiben die Pre-Patch-1-Baseline. Die aktuelle Post-Patch-1-Reality ist im jeweiligen Patch-Final-Report und Handoff-Kontext dokumentiert.
...
**SINGLE_ORDER, wenn mindestens eine der folgenden Alternativen erfüllt ist:**
...
**Hintergrund DE (gesetzlich / EStH / BMF-referenziert):** Aktienverluste sind nur gegen Aktiengewinne verrechenbar (eigener Topf, § 20 EStG). FIFO pro Depot ist verbindlich für die Cost-Basis-Bestimmung.
...
*v1.2, post Patch-1 editorial cleanup. Ready for Patch 2 (Personal-Meta-Konsolidierung + Handoff-Hygiene).*
