...
The smallest follow-up is an external delta review of this contract and handoff.
Implementation-oriented follow-ups should remain contract-first:

- Event Ledger Registry Template / Validation,
