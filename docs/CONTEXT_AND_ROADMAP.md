...
14. Architektur-Baseline: `docs/architecture/` fixiert das sechs-Kernel-Modell fuer Compound Income OS. `docs/contracts/DECISION_STATE_CAPTURE_CONTRACT_V2.md` definiert den naechsten Producer-Vertrag, ist aber noch nicht implementiert. `docs/policies/LLM_CODEX_OPERATING_POLICY.md` haelt fest, dass LLMs/Codex assistieren und nicht entscheiden.

## ROADMAP / Spaeter

- Minimalen Decision-Capture-Producer gegen `docs/contracts/DECISION_STATE_CAPTURE_CONTRACT_V2.md` bauen, bevor Outcome Attribution, Simulation oder Backtesting starten.
