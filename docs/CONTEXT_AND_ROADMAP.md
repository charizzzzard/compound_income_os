...
- `src.personal_run_engine` fuer explizite persoenliche Stage-Orchestrierung, Run-Manifest, Artefaktindex, Run-Report und die read-only `decision_quality`-Stage
