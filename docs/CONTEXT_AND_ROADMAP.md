...
- `src.performance_engine`, `src.cost_tax_engine` und `src.dashboard_engine` fuer Performance-/Benchmark-, Cost-/Tax- und Dashboard-Artefakte
...
7. Performance und Benchmark: `src.performance_engine` erzeugt Benchmark-/Performance-Artefakte mit Snapshot- oder Periodenmodus.
