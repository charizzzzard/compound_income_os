...
| data license/commercial risk | Data source terms may not allow product use. | Commercial packaging violates license constraints. | License boundary contract before commercial packaging. | No canonical license-boundary contract yet. | Future license-boundary review. | Human Operator | KNOWN_GAP |
