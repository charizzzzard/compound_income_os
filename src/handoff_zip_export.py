...
def is_allowed_handoff_artifact(entry_name: str) -> bool:
    ...
    if name.startswith("reports/") and name.endswith("/dashboard_readiness_panel_report.md"):
        return len(name.split("/")) == 3
    if name.startswith("reports/") and name.endswith("/dashboard_readiness_payload_report.md"):
        return len(name.split("/")) == 3
    if name.startswith("reports/") and name.endswith("/website_private_preview_route_matrix_report.md"):
        return len(name.split("/")) == 3
    ...
    if name.startswith("reports/") and name.endswith("/website_private_preview_release_notes.md"):
        return len(name.split("/")) == 3
    if name.startswith("reports/") and name.endswith("/website_private_preview_handoff_qa_report.md"):
        return len(name.split("/")) == 3
    return False
