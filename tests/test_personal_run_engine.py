...
class PersonalRunEngineTests(unittest.TestCase):
    ...
    def test_dashboard_operator_summary_stage_generates_output_and_report_surface(self) -> None:
        ...
        self.assertIn("- data_freshness_status: `FRESH`", run_report)
        self.assertIn("- data_freshness_review_required: `False`", run_report)
        self.assertIn("- data_freshness_stale_count: `0`", run_report)
        self.assertIn("- data_freshness_missing_count: `0`", run_report)
        self.assertIn("- data_freshness_unknown_count: `0`", run_report)
        self.assertIn("- top_reason_codes: `NONE`", run_report)
        self.assertIn("- operator_attention_level: `NONE`", run_report)
        self.assertIn("keine Order-Freigabe", run_report)
        self.assertIn("keine Investment-Confidence", run_report)
